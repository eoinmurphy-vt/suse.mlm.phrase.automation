...
. In the `+Product Description+` field select the {sl-micro} {microversion} or {sles} {bci-mlm} checkbox then use the drop-down to select the `+{productname} Proxy Extension 5.1 x86_64+` extension.
