...
*** For each individual container URL field, use the registry: `+registry.suse.com/suse/multi-linux-manager/5.1/x86_64+` followed by the corresponding suffix, for example, `+_proxy-httpd_+` or `+_salt-broker_+`.
