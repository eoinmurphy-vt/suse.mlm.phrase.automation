...
:description: Learn how to successfully migrate from SUSE Multi-Linux Manager 5.0 to version 5.1 and upgrade the host OS, including procedures for verifying current product
:revdate: 2025-10-19
...
:migration-command: mgradm upgrade
