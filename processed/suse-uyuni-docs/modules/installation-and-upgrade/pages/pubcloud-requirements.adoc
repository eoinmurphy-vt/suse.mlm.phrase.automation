...
:description: Configure SUSE Multi-Linux Manager on public cloud infrastructure with these tested requirements to ensure a secure setup
:revdate: 2025-02-06
...
You can set up the external disk with the `+mgr-storage-server+` command.
