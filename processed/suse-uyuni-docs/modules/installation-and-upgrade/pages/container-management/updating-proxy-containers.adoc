...
Updating the host operating system will also result in the update of the {productname} tooling such as the `+mgrpxy+` tool.
...
. The {productname} Proxy containers running on `+podman+` can be updated using the following command:
