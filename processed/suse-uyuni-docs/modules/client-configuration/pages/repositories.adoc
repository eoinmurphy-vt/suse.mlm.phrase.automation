...
:description: Configure software repositories to install packages from SUSE Multi-Linux Manager channels and from local repositories on clients
:revdate: 2025-02-06
...
| {rhel} and similar derivatives | `+/etc/yum.repos.d/+`
