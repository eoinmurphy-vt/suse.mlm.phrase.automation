...
To create a reactivation key, navigate to `+Systems+`, click the client to create a reactivation key for, and navigate to the menu:Details[Reactivation] tab.
...
Avoid using the `+{productname} Default+` parent channel.
