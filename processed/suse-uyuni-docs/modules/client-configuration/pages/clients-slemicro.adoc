...
:description: Register SLE Micro clients with the SUSE Multi-Linux Manager Server by synchronizing software channels and registering the client via Web UI or command line
:revdate: 2026-06-01
