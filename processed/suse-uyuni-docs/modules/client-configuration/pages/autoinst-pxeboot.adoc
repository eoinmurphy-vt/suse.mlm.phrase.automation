...
[WARNING]
====
If you are using {productname} Proxy 4.3, please consult documentation for 4.3 version [link]``+https://documentation.suse.com/suma/4.3/en/suse-manager/client-configuration/autoinst-pxeboot.html+``.
====
