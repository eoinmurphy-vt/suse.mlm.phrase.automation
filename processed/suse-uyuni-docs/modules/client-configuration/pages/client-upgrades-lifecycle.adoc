...
:description: Upgrade your SUSE Linux Enterprise Server clients using the Content Lifecycle Managers automated process
:revdate: 2024-11-21
...
. Navigate to menu:Systems[System Set Manager > Overview] and click the `+Provisioning+` tab.
