...
:description: Configure automatic client registration using either cloud-init or Terraforms remote execution provisioner
:revdate: 2024-03-05
...
`+user_data+` is run only once at bootstrap, and only the first time the machine is started.
