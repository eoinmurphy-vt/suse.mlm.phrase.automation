...
:description: Register your SUSE Linux Enterprise clients with the SUSE Multi-Linux Manager Server for access to software channels, synchronization tools, and repository
:revdate: 2025-02-06
...
If the client was registered to SCC, SMT, or RMT previously, remove such a registration with `+SUSEConnect+` before migrating the client to {productname} Server.
