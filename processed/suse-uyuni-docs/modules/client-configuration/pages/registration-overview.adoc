...
= Client Registration
:description: Learn how to register clients on a SUSE Multi-Linux Manager Server effectively by considering various registration methods, operating system-specific
:revdate: 2025-02-06
...
To manage {productname} Server Containers, use the `+mgradm+` tool.
