...
:description: Learn how to configure and deploy the best Salt contact method for client communication needs using SUSE Multi-Linux Manager Server
:revdate: 2024-09-27
...
Then, during bootstrapping it will be replaced with `+venv-salt-minion+`.
