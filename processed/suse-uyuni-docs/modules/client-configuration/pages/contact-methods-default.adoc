...
:description: Learn how to configure and manage Salt contacts for your SUSE Multi-Linux Manager server using this process
:revdate: 2025-02-06
...
By default, the {salt} Bundle implementation (`+venv-salt-minion+`) will be deployed.
For more information about {salt} in general, see xref:specialized-guides:salt/salt-overview.adoc[].

ifeval::[{mlm-content} == true]

The default contact method (`+Default+`) is the best scaling method.
