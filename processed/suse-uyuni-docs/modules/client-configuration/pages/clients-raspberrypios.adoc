...
:description: Configure Raspberry Pi OS clients to register with your SUSE Multi-Linux Manager server, accessing required software channels
:revdate: 2026-03-17
...
| {raspberrypios} 13 | Raspberry Pi OS 13 (Tech Preview)
|===
