...
:description: Register cloud guests by disabling automatic registration and enabling SSH access for SUSE Multi-Linux Manager clients
:revdate: 2025-02-06
...
To do this, open the `+/etc/sudoers.d/waagent+` file, and add or edit this line:
