...
:description: Configure registered systems for in-place reinstallation with autoinstallable distributions and profiles
:revdate: 2024-02-19
...
. You can monitor progress of the installation by navigating to menu:Provisioning[Autoinstallation > Session Status], or on the client directly.
  The client reboots, and in the boot menu selects a new choice called `+reinstall-system+`.
