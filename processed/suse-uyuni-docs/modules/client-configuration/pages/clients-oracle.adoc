...
:description: Configure Oracle Linux clients with supported operating systems such as Oracle Linux 9 (x86-64) by adding required software channels, synchronizing them
:revdate: 2026-03-17
...
[IMPORTANT]
====
For {oracle} 10, {oracle} 9 and {oracle} 8 clients, add both the Base and AppStream channels.
