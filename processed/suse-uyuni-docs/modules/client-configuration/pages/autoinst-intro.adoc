...
:description: Learn how to install an operating system and manage clients with SUSE Multi-Linux Manager using various methods, including in-place, network boot, and removable
:revdate: 2025-05-20
...
The sole command-line command supported by Cobbler is `+buildiso+`.
