...
:description: Learn how to register Rocky Linux clients with SUSE Multi-Linux Manager by adding required channels, synchronizing them, and then create an activation key
:revdate: 2026-03-17
...
[IMPORTANT]
====
For {rocky}{nbsp}10, {rocky}{nbsp}9 and {rocky}{nbsp}8 clients, add both the Base and AppStream channels.
