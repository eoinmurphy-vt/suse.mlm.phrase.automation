[[mgr.sync]]
= Using `+mgr-sync+`
:description: Configure channels, organization credentials, and products with SUSE Multi-Linux Manager using the mgr-sync tools various commands and optional arguments
:revdate: 2024-11-29
