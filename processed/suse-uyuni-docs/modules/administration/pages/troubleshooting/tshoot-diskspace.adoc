...
= Troubleshooting Disk Space
:description: Learn how to recover disk space in SUSE Multi-Linux Manager by removing unused software channels, cleaning up activation keys, and deleting obsolete database
:revdate: 2024-06-19
