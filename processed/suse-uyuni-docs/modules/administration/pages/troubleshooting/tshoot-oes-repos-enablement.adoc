...
= Troubleshooting OES repositories enablement
:description: Learn how to troubleshoot and enable OES repositories with SUSE Multi-Linux Manager Server procedures
:revdate: 2022-11-03
...
+
. Go to `+Admin > Setup Wizard > Organization Credentials+` and wait for the refresh operation to complete.
+
