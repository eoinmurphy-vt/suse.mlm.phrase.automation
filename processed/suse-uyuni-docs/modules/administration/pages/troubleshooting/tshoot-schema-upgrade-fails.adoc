...
= Troubleshooting Schema Upgrade Fails
:description: Learn how to troubleshoot and resolve schema upgrade failures in Spacewalk services by identifying the cause of database version check errors, understanding the
:revdate: 2024-05-15
...
Run `+mgradm start+` on the container host for more information and hints how to proceed.
