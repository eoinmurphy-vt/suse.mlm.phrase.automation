...
:description: Configure manual bootstrap repositories for end-of-life products using the mgr-create-bootstrap-repo command to list and create them
:revdate: 2024-10-31
...
--
.. List the available unsupported bootstrap repositories with the `+--force+` option, for example:
+
