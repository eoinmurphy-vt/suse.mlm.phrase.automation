...
= Troubleshooting Notifications
:description: Configure notification settings to optimize message visibility and retention by adjusting the default lifetime in `+/etc/rhn/rhn.conf+` and enabling/disabling
:revdate: 2023-04-11
