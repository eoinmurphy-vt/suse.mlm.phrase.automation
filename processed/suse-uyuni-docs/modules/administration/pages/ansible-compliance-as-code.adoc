[[compliance-as-code]]
= Compliance as Code
:description: Follow these steps Learn remediation techniques by running an Ansible playbook, referencing our step-by-step instructions and configuration guidelines
:revdate: 2025-06-12
...
. To run the playbook, select the `+Inventory Path+` for the clients, for example:
