...
= Task Schedules
:description: Learn to manage and configure predefined task schedules in SUSE Multi-Linux Manager for automating routine maintenance tasks
:revdate: 2026-04-20
...
To disable synchronization set in `+/etc/rhn/rhn.conf+`, run:
+
----
