...
. Navigate to the `+Repositories+` tab, and check the repository to associate with this channel.
...
. OPTIONAL: Navigate to the `+Sync+` tab to set a recurring schedule for synchronization of this repository.
