...
*** For each individual container URL field, use the registry: `+registry.opensuse.org/uyuni+` followed by the corresponding suffix, for example, `+_proxy-httpd_+` or `+_salt-broker_+`.
*** Select the tag from the drop-down list.
