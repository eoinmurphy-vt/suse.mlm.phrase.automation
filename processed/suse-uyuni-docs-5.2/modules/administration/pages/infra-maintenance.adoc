...
For information on using `+transactional-update+`, see https://documentation.suse.com/sle-micro/6.2/html/Micro-transactional-updates/index.html.
...
For example, the major release 5.2 is incremented to 5.2.1 when an MU is released.
