...
[IMPORTANT]
====
Due to the introduction of the xref:administration:reporting-database.adoc[Reporting Database], `+spacewalk-report+` now gathers by default the data from the reporting database. See <<spacewalk-report-reporting-db>> for more information.
====
